...
//
var PersistState = Java.type("com.ti.dvt.uia.utils.PersistState");
var RunParam = Java.type("com.ti.dvt.uia.utils.RunParam");
var Util = Java.type("com.ti.dvt.uia.utils.Util");
//
var Session = Java.type("com.ti.uia.host.core.Session");
...
function setEndpointNames()
{
	if (m_config != null)
	{
		m_endPointNames = new java.util.ArrayList();//Util.getEndPointNames();
