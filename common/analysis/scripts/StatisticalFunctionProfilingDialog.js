...
function configDialogFn() {
	...
	// Sampling Interval for "SamplingPeriodCycles" or "Sampling Interval SWO"
	if (p_trace_uc_helper.jobPropertyExists("SamplingPeriodCycles")) {
	...
	else if (p_trace_uc_helper.jobPropertyExists("Sampling Interval SWO")) {
...
function applyTriggerProperties() {
	...
	// Apply p_SamplingInterval to "Sampling Interval SWO" if exists or default to "SamplingPeriodCycles"
	if (p_trace_uc_helper.jobPropertyExists("Sampling Interval SWO")) {
