...
//  receiverSection.addWidget(label("     "));
	...
	label("Buffer Type:").setEnabled(p_Receiver.equals("560 V2 Trace") || p_Receiver.equals("Pro Trace") || p_Receiver.equals("MTB"));
	receiverSection.addWidget(combobox("Buffer type", p_BufferType));
	combobox("Buffer type").setEnabled(p_Receiver.equals("560 V2 Trace") || p_Receiver.equals("Pro Trace") || p_Receiver.equals("MTB"));
