...
===================================
2018 (c) EWA Technologies, Inc.


=> VERSION

6.2.0.010              12 February 2018


=> WHAT's NEW

Built using InstallBuilder Version: 17.10.0 (2017-10-27)

[LINUX Updates]
	- No changes.

[WIN32 Updates]
	- Updated Windows Device Driver installer v1.18.02.12.
		Re-signed LAN driver package - no changes.
		
	
=> HISTORY 

6.2.0.009              01 January 2018
Built using InstallBuilder Version: 17.10.0 (2017-10-27)
[LINUX Updates]
	- No changes.

[WIN32 Updates]
	- Updated Windows Device Driver installer v1.18.01.11.
		Fixed Bh560v2 INF file.

6.2.0.008              11 December 2017
Built using InstallBuilder Version: 17.10.0 (2017-10-27)

[LINUX Updates]
	- Fixed path for install_scripts folder permissions.

[WIN32 and LINUX Updates]
	- Updated Bh560v2Config Utility.
		Added search option check boxes for USB and LAN.
		Corrected Linux .so file names (lib prefix).
		Improved Linux dbgjtag testing output (xterm window).

		
6.2.0.007              07 November 2017
Built using InstallBuilder Version: 17.10.0 (2017-10-27)
...
[WIN32 Updates]
	- Updated Windows Device Driver installer v1.17.10.12.
		Fixed XDS560v2 STM BSOD and resigned Bh560v2 driver 
			package for Windows 10 using Extended Valuation 
			Code Signing Certificate.

			
6.2.0.005              21 September 2016
Built using InstallBuilder Version: 16.7.0 (2016-07-22)

[LINUX Updates]
	- Fixed glitch on XDS510 USB connections 
		(USBLIB/bh510_server).
...
[WIN32 and LINUX Updates]
	- Removed old driver files not in EPK 6.0.83.0
		(55xp and arm11)
