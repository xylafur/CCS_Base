...
extern "C" {
  ...
  struct DPWM0CLIM_BITS {            // Bits   Description
    ...
    Uint32 ANALOG_PCM_EN:1;          // 15     Analog Peak Current Detection Enable
  ...
  struct FAULT_MUX_REGS {
    ...
    union DPWM0IDEDET_REG       DPWM0IDEDET;      // DPWM 0 IDE Detection Register
    ...
    union DPWM1IDEDET_REG       DPWM1IDEDET;      // DPWM 1 IDE Detection Register
    ...
    union DPWM2IDEDET_REG       DPWM2IDEDET;      // DPWM 2 IDE Detection Register
    ...
    union DPWM3IDEDET_REG       DPWM3IDEDET;      // DPWM 3 IDE Detection Register
