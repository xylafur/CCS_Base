...
extern "C" {
  ...
  struct IOMUX_BITS {          // bits    description
	...
	Uint32 FAULT_01_MUX_SEL:2;  //12:11
    Uint32 EXT_TRIG_MUX_SEL:2; // 10:9     EXT TRIG Pins Mux Control
    Uint32 JTAG_CLK_MUX_SEL:2; // 8:7     JTAG Data Pins Mux Control
    Uint32 JTAG_DATA_MUX_SEL:3;// 6:4     JTAG Data Pins Mux Control
  ...
  struct PWRDISCTRL_BITS {   // bits    Description
    ...
    Uint32 I2C_CLK_EN:1;      // 19      Peak Current Mode Clock Enable
    Uint32 SPI_CLK_EN:1;      // 18      Peak Current Mode Clock Enable
